...
export type EmployeeOffboardingErrorKey =
  ...
  | 'plantilla-no-almacenada'
  | 'plantilla-descarga-fallida'
  | 'plantilla-no-procesable'
  | 'plantilla-protegida-con-contrasena'
  | 'plantilla-de-formulario-dinamico'
  | 'plantilla-sin-campos-rellenables'
  | 'plantilla-con-campo-de-tipo-no-admitido'
  | 'plantilla-con-contenido-activo'
  | 'plantilla-con-envio-a-terceros'
  | 'plantilla-con-campo-de-firma'
