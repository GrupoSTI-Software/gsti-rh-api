...
export default class EmployeeKpiEvaluation extends compose(BaseModel, SoftDeletes, withBusinessUnitScope()) {
  ...
  @beforeCreate()
  static async assignBusinessUnitId(instance: EmployeeKpiEvaluation) {
