...
export const EMPLOYEES_WRITE_PERMISSION_DECLARATIONS = {
  ...
  deleteEmployeeContract: employeesStandard('tab-trabajo-write'),
  assignEmployeeBranchOffice: employeesStandard('tab-trabajo-write'),
  unassignEmployeeBranchOffice: employeesStandard('tab-trabajo-write'),
  ...
  deleteTemporaryAssignment: employeesStandard('tab-trabajo-write'),
