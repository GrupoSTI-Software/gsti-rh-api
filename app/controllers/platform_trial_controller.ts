...
export default class PlatformTrialController {
   ...
   * @security [{"bearerAuth": []}]
   * @responseBody 200 - {"type": "success", "data": {"tenant": {"publicId": "3f2b…", "nombre": "Aceros del Norte"}, "prueba": {"inicio": "2026-08-01", "fin": "2026-08-08", "finEfectivo": "2026-08-08", "diasContratados": 7, "diasTranscurridos": 7, "diasRestantes": 0, "estado": "terminada", "resultado": "convirtio-despues-de-vencer", "fechaResultado": "2026-11-03"}, "hitos": [{"numero": 1, "clave": "estructura", "cumplido": true, "fecha": "2026-08-01"}, {"numero": 2, "clave": "turnos", "cumplido": false, "fecha": "2026-08-01"}, {"numero": 3, "clave": "empleado-con-turno", "cumplido": true, "fecha": "2026-08-02"}, {"numero": 4, "clave": "acceso-app", "cumplido": true, "fecha": "2026-08-02"}, {"numero": 5, "clave": "biometrico", "cumplido": false, "fecha": null}, {"numero": 6, "clave": "primera-checada-real", "cumplido": true, "fecha": "2026-08-03"}, {"numero": 8, "clave": "expediente", "cumplido": false, "fecha": null}]}}
