 ...
 * garante Secretaría de Anticorrupción y Buen Gobierno. El texto está
...
}> = [
  {
    ...
    content: {
      es:
        ...
        '<p><strong>Legislación aplicable.</strong> Estos términos se rigen por las leyes de los Estados Unidos Mexicanos. Cualquier controversia se someterá a los tribunales competentes conforme al contrato de servicio.</p>',
      en:
        ...
        '<p><strong>Governing law.</strong> These terms are governed by the laws of the United Mexican States. Any dispute shall be submitted to the competent courts as set forth in the service agreement.</p>',
    },
  },
  {
    type: 'privacy_notice',
    ...
    content: {
      es:
        ...
        '<p><strong>Conservación y seguridad.</strong> Los datos se conservan durante la relación laboral y los plazos de conservación que exigen las leyes laborales y fiscales, y después se suprimen o disocian. Se aplican medidas de seguridad administrativas, técnicas y físicas, incluido el cifrado en reposo de los datos sensibles y el control de accesos por roles.</p>' +
      ...
      en:
        ...
        '<p><strong>Primary purposes.</strong> Attendance recording and control (including check-in zones with location verification when configured by the Controller); management of shifts, vacations, disability leaves and records; assessments and development; compliance with the Controller’s labor and regulatory obligations under Mexican law; and handling of the data subject’s own requests.</p>' +
        ...
        '<p><strong>Retention and security.</strong> Data is kept during the employment relationship and for the retention periods required by labor and tax laws, and is then deleted or de-identified. Administrative, technical and physical security measures are applied, including encryption at rest of sensitive data and role-based access control.</p>' +
  ...
  },
  {
    ...
    content: {
      es:
        ...
        '<p><strong>Datos que se recaban.</strong> Plantillas biométricas de huella dactilar y de reconocimiento facial, y la fotografía asociada al perfil del empleado, capturadas en los dispositivos de registro (checadores) o desde la aplicación, según lo configure el empleador.</p>' +
        ...
        '<p><strong>Seguridad y conservación.</strong> Las plantillas biométricas se almacenan cifradas, con acceso restringido por roles. Se conservan únicamente durante la vigencia de la relación laboral o hasta la revocación del consentimiento; al concluir cualquiera de las dos, se eliminan de la plataforma y de los dispositivos de registro conforme a los procedimientos del sistema.</p>' +
      ...
      en:
        ...
        '<p><strong>Data collected.</strong> Fingerprint and facial recognition biometric templates, and the photograph associated with the employee profile, captured on attendance devices or from the application, as configured by the employer.</p>' +
        ...
        '<p><strong>Security and retention.</strong> Biometric templates are stored encrypted, with role-restricted access. They are kept only during the employment relationship or until consent is withdrawn; upon either event, they are deleted from the platform and from attendance devices in accordance with system procedures.</p>' +
