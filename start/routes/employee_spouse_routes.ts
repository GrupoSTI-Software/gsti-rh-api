...
router
  .group(() => {
    ...
    router
      .get('/:employeeSpouseId', '#controllers/employee_spouse_controller.show')
      .use(middleware.permissionGate(EMPLOYEES_READ_PERMISSION_DECLARATIONS.showEmployeeSpouse))
  })
