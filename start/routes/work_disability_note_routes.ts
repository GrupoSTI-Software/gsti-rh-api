...
router
  .group(() => {
    router
      ...
      .use(middleware.permissionGate(EMPLOYEES_WRITE_PERMISSION_DECLARATIONS.createWorkDisabilityNote))
    ...
    router
      ...
      .use(middleware.permissionGate(EMPLOYEES_WRITE_PERMISSION_DECLARATIONS.updateWorkDisabilityNote))
    router
      .delete('/:workDisabilityNoteId', '#controllers/work_disability_note_controller.delete')
      .use(middleware.permissionGate(EMPLOYEES_WRITE_PERMISSION_DECLARATIONS.deleteWorkDisabilityNote))
  })
